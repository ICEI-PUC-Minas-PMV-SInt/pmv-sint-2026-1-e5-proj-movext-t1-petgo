...
export default function PerfilPasseador() {
  ...
  const handleAgendar = () => {
    ...
    const servico = servicosCustomizados.find(
        ...
        <View className="bg-white p-8 items-center rounded-b-[40px] shadow-sm border-b border-gray-100">
          ...
          {passeador?.fotoUrl ? (
            ...
            <View className="w-32 h-32 rounded-full bg-blue-100 items-center justify-center border-4 border-blue-50">
              <Text className="text-5xl font-black text-[#4876A8]">
                {inicial}
              </Text>
            </View>
          )}
          ...
          <View className="bg-white p-5 rounded-3xl border border-gray-100 shadow-sm space-y-4">
            ...
            <View className="flex-row items-center">
              ...
              <View className="flex-1">
                ...
                <Text className="text-gray-700 font-medium text-sm">
                  {passeador?.endereco || "Não informado"}
                </Text>
              </View>
            </View>
            ...
            <View className="flex-row items-center">
              ...
              <View className="flex-1">
                ...
                <Text className="text-gray-700 font-medium text-sm">
                  {passeador?.telefone || "Não informado"}
                </Text>
              </View>
            </View>
          </View>
          ...
          {servicosCustomizados.length === 0 ? (
            <View className="bg-white p-10 rounded-[32px] border border-gray-100 items-center justify-center">
              <MaterialCommunityIcons
                ...
                color="#D1D5DB"
              />
              <Text className="text-gray-400 font-bold mt-4 text-center px-6">
                Este passeador ainda não configurou seus serviços.
              </Text>
            </View>
          ) : (
                ...
                return (
                  ...
                  >
                    <View className="flex-1 pr-4">
                      <Text
                        className={`text-lg font-black tracking-tighter ${isSelected ? "text-white" : "text-gray-900"}`}
                      >
                        {servico.nomeTipoPasseio}
                      </Text>
                      <View className="flex-row items-center mt-1">
                        <Feather
                          name="clock"
                        ...
                        />
                        <Text
                          className={`text-xs ml-1 font-bold ${isSelected ? "text-blue-100" : "text-gray-400"}`}
                        >
                    ...
                    <View className="items-end">
                      <Text
                        className={`text-xl font-black ${isSelected ? "text-white" : "text-[#4876A8]"}`}
                      >
